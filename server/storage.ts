...
export class DatabaseStorage implements IStorage {
  ...
  private async initializeOfficialMembers() {
    ...
    const officials = [
      { name: "N. Syifa Wildaini, S.Ked", role: "admin", skills: "Leadership, Medical, Operations", phone: "081214871987" },
      { name: "Muhammad Rehan, S.Ds", role: "admin", skills: "Design Strategy, Photography, Project Mgmt", phone: "08996970613" },
      { name: "Adisti Tristania Firmansyah, S.Ak", role: "admin", skills: "Accounting, Auditing, Finance", phone: "0818140701" },
      { name: "N Sahla Julianti, S.M", role: "admin", skills: "Management, Budgeting, Treasury", phone: "085724712261" },
      { name: "Hafizhah Nasywa Zahira", role: "admin", skills: "Administration, Documentation, Secretariat", phone: "0881023321705" },
      { name: "Fatmah Al Hulaibi", role: "anggota", skills: "Communication, Branding, PR", phone: "085974052656" },
      { name: "Ibrahim Sabit Agustian", role: "anggota", skills: "Communication, Public Speaking", phone: "081299463277" },
      { name: "Theana Ryandianita Putri", role: "anggota", skills: "Communication, Branding, Social", phone: "081299386176" },
      { name: "Citra Aisyah Maulin", role: "anggota", skills: "Event Planning, Coordination", phone: "0882001919825" },
      { name: "Elsa Silalahi", role: "anggota", skills: "Event Planning, Logistics", phone: "085765882051" },
      { name: "Rahma Saharani", role: "anggota", skills: "Event Planning, Logistics", phone: "085722215338" },
      { name: "Salma Safira Adawiyah", role: "anggota", skills: "Event Planning, Coordination", phone: "0882000602339" },
      { name: "Tina Putri Septiyani", role: "anggota", skills: "Event Planning, Logistics", phone: "089697374578" },
      { name: "Dita Dara Dinanti, S.Ds", role: "anggota", skills: "Photography, Graphic Design", phone: "089665060586" },
      { name: "Idzni Syauqina Filzah, S.Ds", role: "anggota", skills: "Photography, Graphic Design", phone: "0895351633000" },
      { name: "Muhammad Ilham Naufal, S.Ds", role: "anggota", skills: "Photography, Video Editing", phone: "0895635018815" },
      { name: "Bayu Ajie Julian", role: "anggota", skills: "IT Development, Copywriting", phone: "085888043754" },
      { name: "Muhammad Raffa Aryadipta", role: "socmed Strategy, Project Management", phone: "087833702913" },
      { name: "Nurul Aulia Annisa", role: "anggota", skills: "Copywriting, Socmed Strategy", phone: "081312306059" },
      { name: "Andhika Zhandhy Anantha", role: "anggota", skills: "Supply Chain, Logistics", phone: "089634754883" },
      { name: "Ade Tita", role: "anggota", skills: "Logistics, General Affairs", phone: "085166322590" },
      { name: "Denisa Agustian, S.Ab", role: "anggota", skills: "Administration, Logistics", phone: "082117715164" },
      { name: "Ega Winia Asyifa, S.Mp", role: "anggota", skills: "Management, Logistics, Agribusiness", phone: "088218606188" },
    ];
