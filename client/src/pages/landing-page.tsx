...
const PROGRAMS: ProgramData[] = [
  {
    ...
    color: "text-blue-600",
    bgColor: "bg-blue-100",
    images: ["/meraki-mengajar-v2-1.jpg", "/meraki-mengajar-v2-2.jpg", "/meraki-mengajar-v2-3.jpg", "/meraki-mengajar-v2-4.jpg", "/meraki-mengajar-v2-5.jpg"],
  ...
  },
  {
    ...
    color: "text-rose-600",
    bgColor: "bg-rose-100",
    images: ["/meraki-kasih-1.jpg", "/meraki-kasih-2.jpg", "/meraki-kasih-3.jpg", "/meraki-kasih-4.jpg", "/meraki-kasih-5.jpg", "/meraki-kasih-6.jpg"],
  ...
  },
  {
    ...
    images: ["/satu-hati-v2-1.jpg", "/satu-hati-v2-2.jpg", "/satu-hati-v2-3.jpg", "/satu-hati-v2-4.jpg", "/satu-hati-v2-5.jpg", "/satu-hati-v2-6.jpg"],
...
export default function LandingPage() {
  ...
  useEffect(() => {
    if (news.length > 0) {
      ...
      if (newsId) {
        const item = news.find((n: News) => n.id === newsId);
        ...
        <section id="tentang" className="py-24 bg-background border-b border-border">
          <div className="container-custom">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-muted-foreground">Visi, Misi, dan Kisah di balik setiap langkah kebaikan kami</p>
            </div>

            {/* Latar Belakang Section */}
            <div className="max-w-4xl mx-auto mb-24 px-4 sm:px-6">
              <div className="relative p-8 md:p-16 bg-white rounded-[2.5rem] md:rounded-[4rem] shadow-strong border border-primary/5 overflow-hidden group hover:border-primary/20 transition-all duration-500">
                ...
                <div className="absolute bottom-0 left-0 w-64 h-64 bg-secondary/5 rounded-full blur-3xl -ml-32 -mb-32 transition-transform duration-700 group-hover:scale-110" />

                <div className="relative z-10 space-y-8">
                  <div className="flex flex-col md:flex-row items-center md:items-start gap-6 mb-4">
                    <div className="p-4 bg-primary/10 rounded-2xl text-primary shadow-soft group-hover:scale-110 transition-transform duration-500">
                      <Sparkles className="w-10 h-10" />
                    </div>
                    <div className="text-center md:text-left">
                      <h3 className="text-3xl md:text-4xl font-heading font-extrabold text-slate-900 tracking-tight mb-2">Kisah Kami</h3>
                      <div className="h-1.5 w-20 bg-primary/20 rounded-full mx-auto md:mx-0 group-hover:w-32 transition-all duration-500" />
                    </div>
                  </div>

                  <div className="space-y-6 text-lg md:text-xl text-slate-700 leading-relaxed font-medium antialiased text-balance">
                    <p>
                      <span className="font-bold text-primary">Meraki Berbagi</span> adalah sebuah organisasi charity yang berbasis di Bandung, yang lahir dari semangat untuk menebar kebaikan melalui rasa, cipta, dan karsa. Dengan fondasi nilai-nilai kepedulian dan gotong royong, kami berfokus pada tiga bidang utama: <span className="text-foreground font-bold">sosial, kemanusiaan, dan pendidikan.</span>
                    </p>
                    <p>
                    ...
                    <div className="p-6 md:p-8 bg-slate-50/50 rounded-3xl border border-slate-100 italic relative group-hover:bg-primary/[0.02] transition-colors">
                      <div className="absolute top-0 left-6 -translate-y-1/2 bg-white px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest text-primary border border-primary/10">Our Commitment</div>
                      <p className="text-slate-800 leading-relaxed">
                        Di Meraki Berbagi, kami tidak hanya bekerja dengan hati, tetapi juga dengan pikiran dan tindakan nyata. Seperti makna <span className="font-bold text-primary not-italic">"Meraki"</span> itu sendiri—melakukan sesuatu dengan sepenuh jiwa—kami berkomitmen untuk terus menjadi ruang tumbuh bagi harapan, inspirasi, dan aksi nyata.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-24 bg-background">
          <div className="container-custom">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-8">
              {["/galeri-baru-1.jpg", "/galeri-baru-2.jpg", "/galeri-baru-3.jpg", "/galeri-baru-4.jpg", "/galeri-baru-5.jpg", "/galeri-baru-6.jpg"].map((src, idx) => (
        ...
        <div className="container-custom">
          <div className="flex flex-col items-center gap-8">
            <div className="flex gap-4">
              <a href="https://www.instagram.com/merakiberbagi_?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noreferrer" className="p-3 bg-white rounded-xl shadow-soft hover:text-primary transition-colors"><Instagram className="w-6 h-6" /></a>
              <a href="https://www.tiktok.com/@meraki.berbagi" target="_blank" rel="noreferrer" className="p-3 bg-white rounded-xl shadow-soft hover:text-primary transition-colors"><Music className="w-6 h-6" /></a>
            </div>
          ...
          {selectedProgram && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                {selectedProgram.images.map((img: string, i: number) => (
